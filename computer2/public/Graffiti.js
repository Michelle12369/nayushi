(function(global) {
    ...
    Graffiti.prototype.clear=function(){
        var ref = new Firebase(this.FIREBASE_URL);
        ref.remove();
        console.log(this.localDrawings.length);
        this.localDrawings.splice(0,this.localDrawings.length);
        this.render();
    }
    ...
    Graffiti.prototype.initChoices = function() {
        ...
        [].forEach.call(types, function(choice) {
            if (choice.id === 'undo') {
                ...
                choice.addEventListener('click', this.clear.bind(this));
            }else {
